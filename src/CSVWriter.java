...
public class CSVWriter	{
    ...
    public void addUser(String name, int height, int age, String sex, int weight, int targetWeight, String targetTime){
        try{
            userWriter = new FileWriter(new File("src/users.csv"), true);
            userWriter.write("\n"+ name + "," + sex + "," + height + "," + weight + "," + age + "," +targetWeight + "," + targetTime);
